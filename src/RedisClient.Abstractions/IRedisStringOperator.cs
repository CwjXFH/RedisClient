...
namespace RedisClient.Abstractions
{
    ...
    /// </summary>
    /// <seealso href="https://redis.io/commands/?group=string"/>
    public interface IRedisStringOperator
    {
        ...
        /// </remarks>
        Task<OperationResult<IDictionary<string, string>>> MGetAsync(ICollection<string> keys,
        ...
        // Available since 7.0.0, not support now.
        /// <summary>
        ...
        /// </returns>
        Task<OperationResult<string>> SetAsync(string key, string value, TimeSpan? expiry = null, bool keepttl = false,
            KeyWriteBehavior writeBehavior = KeyWriteBehavior.None
        ...
        /// </exception>
        Task<OperationResult<T>> SetAsync<T>(string key, T value, TimeSpan? expiry, bool keepttl = false,
            KeyWriteBehavior writeBehavior = KeyWriteBehavior.None
        ...
        #region These commands will possibly be deprecated and finally removed in the future
